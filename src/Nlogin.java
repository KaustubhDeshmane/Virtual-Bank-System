        ...
        b1.addActionListener(
                a -> {
                    if(t1.getText().trim().isEmpty()
                            || String.valueOf(t2.getPassword()).isEmpty()
                    ...
                    if (String.valueOf(t2.getPassword())
                            .equals(String.valueOf(t3.getPassword())))
                    {
                        ...
                        try (Connection con = DriverManager.getConnection(url, "root", "yourpassword")) {
                            ...
                            try (PreparedStatement pst = con.prepareStatement(sql)) {
                                ...
                                pst.setString(2,String.valueOf(t2.getPassword()));
